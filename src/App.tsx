      ...
      <main className=" flex-1 p-6 flex gap-6 ">
        <div className="flex flex-col flex-1">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            <code className="text-violet-400"> {"{transcrição}"} </code> no seu
        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6">
            <label 
            htmlFor="video"
            className="border flex rounded-medium aspect-video cursor-pointer border-dashed
             text-sm flex-col gap-2 items-center justify-center text-muted-foreground hover:bg-primary/20"
            >
          ...
          <div className="spce-y-2">
              ...
              <span className="block text-xs text-muted-foreground italic leading-relaxed">
                Você pode alterar o modelo em breve
              </span>
            </div>
